...
//       {/* Running cards with improved spacing */}
//       <div className="overflow-hidden relative">
//         <div className="inline-flex animate-marquee hover:animation-paused">
//           {projects.concat(projects).map((project, idx) => (
//             <div 
//               key={idx} 
//               className="flex-shrink-0 w-80 mx-4" // Changed from mr-6 to mx-4 for balanced spacing
//             >
//               <ProjectCard
//                 title={project.title}
//                 main={project.main}
...
//           }
//           .animate-marquee {
//             animation: marquee 40s linear infinite; /* Slowed down for better visibility */
