...
//             <img className="md:h-200 md:w-200" src={AboutImg} alt="About img" />
//           </div>
...
//           {/* LEFT IMAGE */}
//           <div className="flex justify-center">
//             <img className="md:h-150 md:w-85" src={AboutImg} alt="About img" />
//           </div>
        ...
        <div className="flex flex-col md:flex-row gap-10 mt-10 items-start">
          ...
          {/* <div className="flex justify-center">
            ...
            />
                ...
                <div className="flex justify-center">
             <img className="md:h-150 md:w-84 rounded-xl shadow-lg object-cover" src={AboutImg} alt="About img" />
          </div>
